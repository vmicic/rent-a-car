package com.rentacar.userservice.config;

import com.rentacar.userservice.security.TokenUtils;
import com.rentacar.userservice.security.auth.RestAuthenticationEntryPoint;
import com.rentacar.userservice.security.auth.TokenAuthenticationFilter;
import com.rentacar.userservice.service.impl.MyUserDetailService;
...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.POST, "/auth/**", "/ws/**");
